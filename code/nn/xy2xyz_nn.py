...
# plt.legend(loc='best')
#
# plt.suptitle('xy to xyz', fontsize=16)
# plt.tight_layout()
# plt.show()
...
#
# # saving the model
# model.save("models/xy_to_xyz/xy_to_xyz_model.keras")
#
# # saving normalization parameters
# with open('models/xy_to_xyz/xy_to_xyz_model_mean_std.txt', 'w') as f:
