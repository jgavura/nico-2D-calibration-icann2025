...
# Load data xy to joints
data_x, data_y = load_data('joints')
...
# plt.legend(loc='best')
#
# plt.suptitle('xy to joints', fontsize=16)
# plt.tight_layout()
# plt.show()
...
#
# # saving the model
# model.save("models/xy_to_joints/xy_to_joints_model.keras")
#
# # saving normalization parameters
# with open('models/xy_to_joints/xy_to_joints_model_mean_std.txt', 'w') as f:
